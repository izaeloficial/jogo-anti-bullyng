...
// Consolidated main game file with all fixes and dilemma system
// ============================================================================

// Global state flags to prevent multiple starts and duplicates
...
function playSweep(f1, f2, type, duration, gainNode, fadeTime) {
  ...
  } catch (e) { console.warn('playSweep error:', e); }
}
...
function playNoise(duration, gainNode, level) {
  ...
  } catch (e) { console.warn('playNoise error:', e); }
}
...
function sfxCorrect() { ensureAudio(); if (sfxGainNode) { playTone(523, 'triangle', 0.12, sfxGainNode, 0, 0.25); playTone(659, 'triangle', 0.12, sfxGainNode, 0.1, 0.25); playTone(880, 'triangle', 0.16, sfxGainNode, 0.2, 0.25); } }
...
function handleKeyDown(e) {
  ...
  if (['a', 'd', 'arrowleft', 'arrowright', 'arrowup', 'arrowdown'].includes(e.key.toLowerCase())) e.preventDefault();
}
